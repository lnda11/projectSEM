                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th><center>Unit Price (RM)</center></th>
                            <th><center>Quantity</center></th>
                            <th><center>Subtotal (RM)</center></th>
                    ...
                    <tbody>
                        <?php foreach($data as $row){ 
                            ...
                            <form action="" method="POST">
                                <tr>
                                    <td>
                                        <input type="text" name="itemname" value="<?=$row['itemname']?>" class="noborder" readonly>
                                    </td>
                                    <td>
                                        <input type="text" name="itemprice" value="<?=$row['itemprice']?>" class="noborder" readonly>
                                    </td>
                                    <td>
                                        <input type="number" name="itemquantity" value="<?=$row['itemquantity']?>" class="noborder" style="width: 3em;">
                                    </td>
                                    <td>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <button type="submit" name="delete" onclick="return confirm('Are you sure to delete?');">
                                            <img src="Image/deleteicon.png" alt="deleteicon" width="40px" height="40px">
                                        </button>
                                        <button type="submit" name="update" onclick="return confirm('Do you want to update the selected row data.');">
                                            <img src="Image/updateicon.png" alt="updateicon" width="40px" height="40px">
                                        </button>
                                    </td>
                                </tr>
                            </form>
            ...
            <form action="" method="POST">
                <div style="text-align: center;">
                    ...
                    <button name="checkout" class="btn btn-primary">
                        <a href="../managePayment/paymentCheckout.php?custID=<?=$_SESSION['custID']?>" style="text-decoration: none; color: white;">Check Out</a>
                    </button>
                </div>
            </form> 
        </center>      
