...
<html>
    ...
    <body>
        ...
        <center>
        <h3 style="margin-left: 1em; margin-top: 1em;"><b>RUNNER PROFILE<b></h3>
        <div style="margin-top: 31px; margin-left: 1em;">
            <form action="" method="POST">
                ...
                <table>
					...
					<tr>
					<img src="<?php echo '../manageLoginAndRegister/Image/'.$row["runnerimage"];?>"  height="150"  width="150">
					</tr>
                    <tr>
